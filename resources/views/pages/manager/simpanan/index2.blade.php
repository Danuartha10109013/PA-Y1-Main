...
.btn:disabled {
    cursor: not-allowed; /* Tanda larangan saat hover */
    opacity: 0.6;        /* Terlihat seperti tidak aktif */
            ...
            <tbody id="table-body">
                ...
                <tr>
                    ...
                    <td class="action-icons">
                        <a href="{{ route('simpanan.berjangka.detail', $data->no_simpanan) }}" style="z-index: 9999; position: relative;">
