...
class CreateRekeningSimpananSukarelaTable extends Migration
{
    /**
     * Run the migrations.
     */
    public function up()
    {
        Schema::create('rekening_simpanan_sukarela', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rekening_simpanan_sukarela');
    }
}
